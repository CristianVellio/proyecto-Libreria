      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Pedidos Totales</span>
          </div>
        </div>
      </section>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div className="px-6 py-5 font-semibold border-b border-gray-100">
            El numero de Pedidos Mensuales
          </div>
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">
              Visitas al Sitio (en el Ultimo Dia)
            </span>
          </div>
        </div>
        <div className="row-span-3 bg-white shadow rounded-lg">
          <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
            <span>Usuario por Pedidos</span>
            <button
              type="button"
          ...
          <div className="overflow-y-auto" style={{ maxHeight: "24rem" }}>
            <ul className="p-6 space-y-6">
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Anita Morris</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Cosme Fulanito</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Rafael Ricardo</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Ben Diez</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Carla Origen</span>
                <span className="ml-auto font-semibold">8.2</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <span className="text-gray-600">Juana Solari</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Patricia Split</span>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Juan Verso</span>
